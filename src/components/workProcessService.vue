<template>
        <div class="pt-[40px] pb-[40px] xl:pr-[140px] md:pr-[80px] sm:pr-[32px] pr-[20px] xl:pl-[140px] md:pl-[80px] sm:pl-[32px] pl-[20px]">
            <div class="flex flex-col gap-[60px] bg-[#004B49] pt-[40px] pb-[60px] sm:pr-[40px] pr-[20px] sm:pl-[40px] pl-[20px]">
                <div class="flex justify-center items-center lg:flex-row flex-col gap-[10px]">
                    ...
                    <div class="sm:w-[350px] sm:h-[350px] flex justify-center items-center">
                        <img src="@/assets/workIllustration.png" alt="Profile" class="w-[316px] h-auto" />
                    </div>
                </div>
                <div class="flex flex-col gap-[40px]">
                    <div>
                        <p class="font-supreme font-medium sm:text-[24px] text-[20px] text-white">Our Work Process</p>
                    </div>
                    <div class="flex flex-col gap-[60px]">
                        <div class="flex lg:flex-row flex-col lg:gap-[120px] gap-[20px]">
                            <table>
