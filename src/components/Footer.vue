  ...
  <footer class="bg-[#001412] text-white px-8 md:px-32 py-16 flex flex-col">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div class="flex flex-col w-[273px] h-[284px] gap-5">
        ...
        <div class="flex flex-col gap-3">
          <p class="font-[Supreme] font-bold text-[20px] leading-[26px] tracking-[-0.02em]">Address</p>
          <p class="font-[Supreme] font-bold text-[18px] leading-[23px] tracking-[-0.02em]">2352 Middlefield Rd, Markham <br> Ontario, Canada</p>
        </div>
      </div>
    </div>
  </footer>
